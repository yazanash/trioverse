                  ...
                  <main>
                      <div class="row g-5">
                        <div class="col-md-9 col-lg-10">
                          <form method="POST" action="{{route('licenses.store',$gym_id)}}" class="needs-validation" novalidate="">
                           @csrf
                              <div class="row g-3">
                              <div class="col-sm-6">
                                ...
                                <div class="input-group mb-3">
                                  <select class="form-select @error('plan_id') is-invalid @enderror" id="plan_id" name="plan_id" aria-label="Default select example">
                                    ...
                                    <option value="{{$plan->plan_id}}">{{$plan->plan_name}} - {{$plan->price}}</option>
                                    @endforeach
                                  </select>
                                  @error('plan_id')
                              ...
                              <div class="col-sm-6">
                                ...
                                <input type="date" class="form-control @error('subscribe_date') is-invalid @enderror" id="subscribe_date" name="subscribe_date"  required>
